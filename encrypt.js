...
const FULL_DATA = {
  ...
  benoit2026: {
    ...
    councils: [
      ...
      // AZCS0011 — source : relevé bancaire (virement reçu 02/08/2026,
      // « MAJALIS CONSULTING SERVICE », communication AZCS0011, 6 050,00 EUR).
      // 6 050 TTC ÷ 1,21 = 5 000 € HT exactement, soit 8 j × 625 € (même profil
      // qu'AZCS0001/0002). ⚠️ mois et jours DÉDUITS du montant, pas confirmés par
      // une facture : aucun mail AZCS0011 trouvé. dateFacture volontairement omise.
      { ref: "AZCS0011", mois: "Juillet 2026", jours: 8, htEUR: 5000, tauxApplique: 10.600, statut: "ok", statutText: "Paid 02/08" },
    ],
    virements: [
  ...
  fxP2P: {
    ...
    leg3: {
      ...
      tauxMarche: {
        ...
        "2026-04-22": 9.2545, "2026-05-11": 9.1214,
      },
      transactions: [
        ...
        { date: "2026-04-22", usdt: 2085.50, mad: 20000.00, prix: 9.590 },
        { date: "2026-05-11", usdt:  519.21, mad:  5000.00, prix: 9.630 },
        { date: "2026-05-11", usdt: 2076.84, mad: 20000.00, prix: 9.630 },
        { date: "2026-05-11", usdt:  623.05, mad:  6000.00, prix: 9.630 },
        { date: "2026-05-11", usdt:  934.57, mad:  9000.00, prix: 9.630 },
        { date: "2026-05-11", usdt:  830.73, mad:  8000.00, prix: 9.630 },
        { date: "2026-05-11", usdt: 2489.62, mad: 24000.00, prix: 9.640 },
        { date: "2026-05-11", usdt: 1400.41, mad: 13500.00, prix: 9.640 },
      ],
    },
    usdtRemaining: 937.10,
    // ==================================================================
    ...
    merchantsAED: [
      "-Pro-Merchant", "abdullah_trader2", "Abdulla_Saif_Mohamme", "Abu_Sultan_BTC",
      "AbuBakar_474", "AlaibanQ8", "Amoun-AZ", "amro_sd", "AquaXchange",
      "Aureus FZ", "Axa00", "Baasher", "Captain5aled", "Exchangify-Enterpris",
      "FBSTrader", "ISLAMIC_CRYPTO", "LinkPay", "Loma_1", "M7usdt",
      "Maximilianthefirst", "MBebars", "mgrabit", "Miami trader", "Mooddy",
      "Muzamil2176", "OFFICIAL__MERCHANT", "P2P-82159eq4", "P2P-d921c7cn",
      "RMK LTD", "Saibo7", "SalimCapital", "ShefyZ_CryptO_WorLD", "SwappyCrypto",
      "Takethiswave", "ThePenguin29", "UnitedCoinEmirates", "WhiteMoney-UAEIND",
    ],
    confirmedMerchantsAED: [
      "Abdulla_Saif_Mohamme", "Abu_Sultan_BTC", "Amoun-AZ", "amro_sd",
      "AquaXchange", "Baasher", "ISLAMIC_CRYPTO", "Loma_1", "RMK LTD",
      "ThePenguin29", "UnitedCoinEmirates",
    ],
    ...
    merchantsMAD: [
      ...
      "P2P-59dbaepc", "P2P-604a69za", "P2P-76c3f3dh", "P2P-84688af7",
      "P2P-c22d1fnt", "P2P-F2F", "P2P-fc2d6fbv", "pokito",
      "R-A-H-I-L", "Rachid_Erin", "Rocket_-_", "SafeCoinsExpress",
      "said rabede", "SALHICHRIF", "Sana_P2P_Trusted", "sethn11", "TecTac",
      "Transaction Rapide", "User-040fe", "User-35404", "User-61fed",
      "User-72beb", "User-732eb", "User-7b67a", "User-859a0", "User-a765f",
    ...
    confirmedMerchantsMAD: [
      ...
      "Imhere_welcome", "Itsjustme01", "khalid mechti", "liltax", "MAK_CASH",
      "meriem-service", "MostExpress", "Osmorty", "Otomai", "P2P-4de193tz",
      "P2P-59dbaepc", "P2P-604a69za", "P2P-76c3f3dh", "P2P-c22d1fnt", "P2P-F2F",
      "R-A-H-I-L", "Rachid_Erin", "Rocket_-_", "SafeCoinsExpress",
      "said rabede", "SALHICHRIF", "Sana_P2P_Trusted", "sethn11", "TecTac",
      "Transaction Rapide", "User-040fe", "User-35404", "User-61fed",
      "User-732eb", "User-7b67a", "User-859a0", "User-a765f", "User-c86e6",
      "User-f38af", "Yusuf-Cryptomonnaie",
    ],
  },
